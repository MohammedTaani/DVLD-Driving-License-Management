...
namespace DVLD_Driving_License_Management
{
    public partial class frmVisionTestAppointments : Form
    {
        ...
        public frmVisionTestAppointments(int ApplicationID , string ClassName , int PassedTests , int LokalApplicationID , int UserID)
        {
            InitializeComponent();
            ...
            // Vision Test hat nummer 1 in DataBase

            appointmentTestControl1.LoadData(ApplicationID , 1 , UserID);
